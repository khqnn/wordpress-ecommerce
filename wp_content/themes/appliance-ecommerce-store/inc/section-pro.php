 ...
 * @access public
 */
class Appliance_Ecommerce_Store_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'appliance-ecommerce-store';
...
class Appliance_Ecommerce_Store_Button extends WP_Customize_Section {
