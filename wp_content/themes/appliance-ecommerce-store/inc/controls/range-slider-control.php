 ...
 */
/** Range Control */
class Appliance_Ecommerce_Store_Range_Slider extends WP_Customize_Control {
    /**
    ...
    public function enqueue() {
        wp_enqueue_style( 'appliance_ecommerce_store-range-control-styles', get_parent_theme_file_uri( '/assets/css/controls/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'appliance_ecommerce_store-range-control-scripts', get_parent_theme_file_uri( '/assets/js/controls/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
