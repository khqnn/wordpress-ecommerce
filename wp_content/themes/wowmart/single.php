...
?>
<div class="<?php echo esc_attr($wowmart_blog_container); ?> mt-3 mb-5 pt-5 pb-3">
	<div class="row">
		...
		<div class="col-lg-<?php echo esc_attr($wowmart_column_set); ?>">
			<main id="primary" class="site-main">
				...
				while (have_posts()) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'wowmart') . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'wowmart') . '</span> <span class="nav-title">%title</span>',
						)
					);
