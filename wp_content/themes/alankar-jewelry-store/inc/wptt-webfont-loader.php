...
if ( ! class_exists( 'Luzuk_Alankar_Jewelry_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Luzuk_Alankar_Jewelry_Store_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Luzuk_Alankar_Jewelry_Store_WPTT_WebFont_Loader( $url );
