 ...
 *
 * @package WordPress
 * @subpackage Alankar_Jewelry_Store
 * @since Alankar Jewelry Store 1.0
 */

if ( ! class_exists( 'Alankar_Jewelry_Store_Walker_Page' ) ) {
	/**
	 * CUSTOM PAGE WALKER
	 ...
	 * @since Alankar Jewelry Store 1.0
	 */
	class Alankar_Jewelry_Store_Walker_Page extends Walker_Page {

		/**
		 * Outputs the beginning of the current element in the tree.
		 *
		 * @since Alankar Jewelry Store 1.0
		 * @since Alankar Jewelry Store 1.9 Renamed `$page` to `$data_object` and `$current_page` to `$current_object_id`
		...
		public function start_el( &$output, $data_object, $depth = 0, $args = array(), $current_object_id = 0 ) {
			...
			if ( '' === $page->post_title ) {
				...
				$page->post_title = sprintf( __( '#%d (no title)', 'alankar-jewelry-store' ), $page->ID );
			}
