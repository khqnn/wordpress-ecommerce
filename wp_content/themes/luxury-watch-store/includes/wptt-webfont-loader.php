...
if ( ! class_exists( 'Luxury_Watch_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Luxury_Watch_Store_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'luxury_watch_store_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function luxury_watch_store_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Luxury_Watch_Store_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'luxury_watch_store_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function luxury_watch_store_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Luxury_Watch_Store_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
