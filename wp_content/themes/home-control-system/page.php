...
<div id="content" class="mt-5">
  <div class="container">
    <?php $home_control_system_single_page_layout = get_theme_mod( 'home_control_system_single_page_layout','One Column');
      if($home_control_system_single_page_layout == 'One Column'): ?>
          <?php
            while ( have_posts() ) :
              the_post();
            ...
            endwhile;
          ?>
      <?php elseif ($home_control_system_single_page_layout == 'Left Sidebar') : ?>
        <div class="row">
      ...
      <?php elseif ($home_control_system_single_page_layout == 'Right Sidebar') : ?>
        <div class="row">
          <div class="col-lg-8 col-md-8">
            <?php
              while ( have_posts() ) :
