...
if ( ! class_exists( 'Home_Control_System_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Home_Control_System_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'home_control_system_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function home_control_system_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Home_Control_System_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'home_control_system_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function home_control_system_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Home_Control_System_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
