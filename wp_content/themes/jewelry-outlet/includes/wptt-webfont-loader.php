...
if ( ! class_exists( 'Jewelry_Outlet_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Jewelry_Outlet_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'jewelry_outlet_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function jewelry_outlet_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Jewelry_Outlet_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'jewelry_outlet_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function jewelry_outlet_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Jewelry_Outlet_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
